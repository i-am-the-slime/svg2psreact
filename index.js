...
(function($PS) {
  ...
  var Text_Parsing_StringParser = $PS["Text.Parsing.StringParser"];                
  var stripSuffixOrNot = function (suffix) {
      return function (s) {
          return Data_Maybe.fromMaybe(s)(Data_String_CodeUnits.stripSuffix(suffix)(s));
      };
  };
  ...
  var renderStyle = function (style) {
      ...
      var styles = Data_Array.filter(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_HeytingAlgebra.conj(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Eq.eq(Data_Eq.eqString)(" "))(Data_Eq.eq(Data_Eq.eqString)("\x0a"))))(Data_String_Common.split(";")(style));
      ...
      return "R.css { " + (styleAttrs + " }");
  };
  var renderAttribute = function (v) {
      if (v.value0 === "style") {
          return "style: " + renderStyle(v.value1);
      };
      if (v.value0 === "class") {
          return "className:" + quoted(v.value1);
      };
  ...
  var renderNode = function (depth) {
      return function (v) {
          ...
          if (v instanceof Svg_Parser.SvgText) {
              return "R.text " + quoted(v.value0);
          };
          if (v instanceof Svg_Parser.SvgComment) {
              return v.value0;
          };
          throw new Error("Failed pattern match at Main (line 100, column 20 - line 103, column 32): " + [ v.constructor.name ]);
      };
  };
  var renderElement = function (depth) {
      return function (v) {
          var spc = repeatS(depth)(" ");
          var name$prime = "SVG." + v.name;
          ...
          var commaBeforeChildren = (function () {
              var $20 = Data_Foldable["null"](Data_List_Types.foldableList)(attrs) || Data_Foldable["null"](Data_List_Types.foldableList)(v.children);
              if ($20) {
                  return "";
              };
              return brkSpc + ", ";
          ...
          var children$prime = commaBeforeChildren + (function () {
              var $21 = Data_Foldable["null"](Data_List_Types.foldableList)(v.children);
              if ($21) {
                  return "";
              };
  ...
  var getLastSplit = function (pattern) {
      return function (s) {
          return Data_Maybe.fromMaybe(s)(Data_Array.last(Data_String_Common.split(pattern)(s)));
      };
  };
  var sanitiseFileName = (function () {
      var $33 = Data_String_Common.replaceAll("\\")("/");
      var $34 = getLastSplit("/");
      var $35 = stripSuffixOrNot(".svg");
      var $36 = stripSuffixOrNot(".SVG");
      var $37 = Data_String_Common.replaceAll(" ")("_");
      return function ($38) {
          return $33($34($35($36(Data_String_Common.trim($37($38))))));
      };
  })();
  var header = function (modulePrefix) {
      return function (fileName) {
          var sanitisedFileName = sanitiseFileName(fileName);
          var varName = Data_String_Extra.camelCase(sanitisedFileName);
          var moduleName = modulePrefix + ("." + Data_String_Extra.pascalCase(sanitisedFileName));
          return "module " + (moduleName + (" where\x0a\x0aimport React.Basic (JSX)\x0aimport React.Basic.DOM as R\x0aimport React.Basic.DOM.SVG as SVG\x0a\x0a" + (varName + (" :: JSX\x0a" + (varName + " = ")))));
      };
  };
  var parse = function (modulePrefix) {
      return function (fileName) {
          return function (s) {
              return Data_Functor.mapFlipped(Data_Either.functorEither)(Svg_Parser.parseToSvgNode(s))(function (g) {
                  return header(modulePrefix)(fileName) + renderNode(4)(g);
              });
          };
      };
  };
  var main = function __do() {
      ...
      var v = Data_Array.last($$arguments);
      if (v instanceof Data_Maybe.Just) {
          var s = Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)(v.value0)();
          var v1 = parse("Assets")(v.value0)(s);
          if (v1 instanceof Data_Either.Left) {
              return Effect_Console.log(Data_Show.show(Text_Parsing_StringParser.showParseError)(v1.value0))();
          };
          if (v1 instanceof Data_Either.Right) {
              return Effect_Console.log(v1.value0)();
          };
          throw new Error("Failed pattern match at Main (line 34, column 7 - line 36, column 35): " + [ v1.constructor.name ]);
      };
      if (v instanceof Data_Maybe.Nothing) {
          return Effect_Console.error("Usage: node index.js pathToSvgFile")();
      };
      throw new Error("Failed pattern match at Main (line 31, column 3 - line 37, column 60): " + [ v.constructor.name ]);
  };
  var processAllInDirectory = function (modulePrefix) {
      return function (dir) {
          var processFile = function (filePaths) {
              return function (filePath) {
                  var svgFilePath = Node_Path.concat([ dir, filePath ]);
                  var nameWithoutSuffix = stripSuffixOrNot(".SVG")(stripSuffixOrNot(".svg")(filePath));
                  var purescriptName = Data_String_Extra.pascalCase(nameWithoutSuffix) + ".purs";
                  var notAlreadyWritten = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(purescriptName)(filePaths);
                  var pursFilePath = Node_Path.concat([ dir, purescriptName ]);
                  var isSVGFile = Data_HeytingAlgebra.disj(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_String_Utils.endsWith(".svg"))(Data_String_Utils.endsWith(".SVG"))(filePath);
                  return Control_Applicative.when(Effect_Aff.applicativeAff)(isSVGFile && notAlreadyWritten)(Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(svgFilePath))(function (svgString) {
                      var v = parse(modulePrefix)(svgFilePath)(svgString);
                      if (v instanceof Data_Either.Left) {
                          return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("Parse error on " + (svgFilePath + ("\x0d\x0aError: " + Data_Show.show(Text_Parsing_StringParser.showParseError)(v.value0)))));
                      };
                      if (v instanceof Data_Either.Right) {
                          return Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(pursFilePath)(v.value0);
                      };
                      throw new Error("Failed pattern match at Main (line 51, column 7 - line 53, column 85): " + [ v.constructor.name ]);
                  }));
              };
          };
          return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readdir(dir))(function (filePaths) {
              return Control_Parallel.parTraverse_(Effect_Aff.parallelAff)(Data_Foldable.foldableArray)(processFile(filePaths))(filePaths);
          }));
      };
  };
  var convertAllSVGsInDirectory = Effect_Uncurried.mkEffectFn2(processAllInDirectory);
  exports["main"] = main;
  exports["convertAllSVGsInDirectory"] = convertAllSVGsInDirectory;
  exports["processAllInDirectory"] = processAllInDirectory;
  exports["parse"] = parse;
  exports["header"] = header;
  exports["sanitiseFileName"] = sanitiseFileName;
  exports["stripSuffixOrNot"] = stripSuffixOrNot;
  exports["getLastSplit"] = getLastSplit;
